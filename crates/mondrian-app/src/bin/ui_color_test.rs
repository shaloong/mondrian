    ...
    el.run(move |ev, elwt| {
        ...
        match ev {
            ...
            Event::WindowEvent { event: WindowEvent::RedrawRequested, .. } => {
                ...
                enc.draw_rect(Rect::new(0.0, 0.0, 900.0, 400.0), Color::from_hex(0x121212), 0.0);
                // Red rect on left
                enc.draw_rect(Rect::new(50.0, 50.0, 200.0, 300.0), Color { r: 1.0, g: 0.0, b: 0.0, a: 1.0 }, 0.0);
                // Green rect in middle
                enc.draw_rect(Rect::new(350.0, 50.0, 200.0, 300.0), Color { r: 0.0, g: 1.0, b: 0.0, a: 1.0 }, 0.0);
                // Blue rect on right
                enc.draw_rect(Rect::new(650.0, 50.0, 200.0, 300.0), Color { r: 0.0, g: 0.0, b: 1.0, a: 1.0 }, 0.0);
                let cmds = enc.finish();
