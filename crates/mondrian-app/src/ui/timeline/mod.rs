...
pub(crate) enum TimelineScrollbarDragKind {
    Thumb,
    LeadingHandle,
    TrailingHandle,
}
...
#[derive(Debug, Clone, Copy)]
pub(crate) struct TimelineScrollbarDragState {
...
#[derive(Debug, Clone, Copy)]
pub(crate) struct TimelineScrollbarMetrics {
    total_frames: f64,
...
#[derive(Debug, Clone, Copy)]
pub(crate) struct TimelineVerticalScrollbarDragState {
...
#[derive(Debug, Clone, Copy)]
pub(crate) struct TimelineVerticalScrollbarMetrics {
    total_rows: f32,
    visible_rows: f32,
    thumb_top: f32,
    thumb_height: f32,
