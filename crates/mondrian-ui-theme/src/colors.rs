...
pub struct ColorTokens {
    ...
    pub timeline_clip_adjustment: Color,
    pub timeline_clip_adjustment_hover: Color,
    pub timeline_clip_nested: Color,
    pub timeline_clip_nested_hover: Color,
    pub timeline_clip_solid: Color,
    pub timeline_clip_solid_hover: Color,
    pub timeline_clip_title: Color,
    pub timeline_clip_title_hover: Color,
    pub timeline_clip_adjustment_selected_border: Color,
    pub timeline_clip_nested_selected_border: Color,
...
impl ColorTokens {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            timeline_clip_adjustment: Color::from_hex(0x625080),
            timeline_clip_adjustment_hover: Color::from_hex(0x755DA0),
            timeline_clip_nested: Color::from_hex(0x2F74A0),
            timeline_clip_nested_hover: Color::from_hex(0x3783B3),
            timeline_clip_solid: Color::from_hex(0x6B4D3A),
            timeline_clip_solid_hover: Color::from_hex(0x805A42),
            timeline_clip_title: Color::from_hex(0x76517E),
            timeline_clip_title_hover: Color::from_hex(0x8C6095),
    ...
    pub fn light() -> Self {
        Self {
            ...
            timeline_clip_adjustment: Color::from_hex(0xEDE9FE),
            timeline_clip_adjustment_hover: Color::from_hex(0xDDD6FE),
            timeline_clip_nested: Color::from_hex(0xDBEAFE),
            timeline_clip_nested_hover: Color::from_hex(0xBFDBFE),
            timeline_clip_solid: Color::from_hex(0xFCE7F3),
            timeline_clip_solid_hover: Color::from_hex(0xFBCFE8),
            timeline_clip_title: Color::from_hex(0xF3E8FF),
            timeline_clip_title_hover: Color::from_hex(0xE9D5FF),
