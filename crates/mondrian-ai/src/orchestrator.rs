...
use mondrian_core::{events::{AppEvent, EventBus}, Result};
use std::sync::Arc;
...
impl AgentOrchestrator {
    ...
    pub async fn run_workflow(
        ...
        self.event_bus.publish(AppEvent::WorkflowStarted {
        ...
        self.event_bus.publish(AppEvent::WorkflowCompleted {
            workflow_name: workflow.name.clone(),
        });
    ...
    async fn action_generate_image(
        &self, _ctx: &WorkflowContext, _step: &crate::workflow::StepDef,
    ) -> Result<()> {
