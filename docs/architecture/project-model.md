...
schema v14 is the sole accepted author schema, and older/future versions fail
...
Current document schema v14 persists canonical rational `TimelineTime` values
