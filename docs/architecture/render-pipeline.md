...
post-encode contract probes only the first decoded video frame when static HDR10
...
static HDR10 preservation incur no frame-side-data probe. The effective
