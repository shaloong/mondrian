...
- Every Effect pixel and GPU-plan cache belongs to one **Effect Execution Session**. Preview binds the sole Preview generation authority; Export binds the queue's exact attempt generation. Rotation retires every encoded, Float32, node, temporal, GPU-plan, and deterministic-blocker entry together, and no resource decision or cancellation in one consumer may mutate another consumer's residency.
