...
- A **Prepared Audio Schedule** propagates algorithmic latency, **Audio Processor Tail**, and state-entry obligations through every Contribution, port-specific Route, processor rack, and nested public output; missing child preparation facts fail closed and can never be inferred as zero or stateless.
