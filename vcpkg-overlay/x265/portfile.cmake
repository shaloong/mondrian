...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DENABLE_PIC=ON
        -DENABLE_LIBNUMA=OFF
        # Mondrian's HEVC Main10 delivery requires a 10-bit-capable x265;
        # the stock port builds an 8-bit-only library and FFmpeg silently
        # downgrades `yuv420p10le` to `yuv420p`, shipping Main10 presets as
        # 8-bit files. Enable the high-bit-depth library explicitly.
        -DHIGH_BIT_DEPTH=ON
        "-DVERSION=${VERSION}"
    OPTIONS_DEBUG
        -DENABLE_CLI=OFF
